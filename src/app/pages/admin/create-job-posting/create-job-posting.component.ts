...
export class CreateJobPostingComponent {
  ...
  constructor(
    ...
    this.jobForm = new FormGroup({
      ...
      short_description: new FormControl('',[Validators.required,Validators.min(2), this.minLengthWithoutSpaces(2), Validators.maxLength(250)]),
      full_description: new FormControl('', [ Validators.required,Validators.min(2), this.minLengthWithoutSpaces(2), Validators.maxLength(1000)]),
      assignment_duration: new FormControl('',[ Validators.required, Validators.min(2),this.minLengthWithoutSpaces(2),  Validators.maxLength(50)]),
      employer: new FormControl('',[ Validators.required, Validators.min(2),  Validators.maxLength(100)]),
      required_experience: new FormControl('',[ Validators.required, Validators.maxLength(50)] ),
      ...
      application_instruction: new FormControl('',[Validators.required, Validators.min(2), this.minLengthWithoutSpaces(2), Validators.maxLength(1500)]),
