...
export class CreateJobPostingDto {
  @ApiProperty({
    example: 'job-id-1',
    description: 'Unique identifier for the job posting (optional)',
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiProperty({
    description: 'The qualifications required',
...
export class FindAllJobPostingsQueryDto {
  ...
  @ApiPropertyOptional({
    description: 'Search keyword for job title or employer',
    example: 'Engineer',
  })
  @IsOptional()
  @IsString()
...
export class FindOneJobPostingQueryDto {
  @ApiProperty({
    description: 'The key to search by (e.g., id, title)',
    example: 'id',
  })
  @IsString()
