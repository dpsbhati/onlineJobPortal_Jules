...
describe('SocialShareService', () => {
  ...
  describe('generateFacebookShareUrl', () => {
    it('should generate correct Facebook share URL', () => {
      ...
      const result = service.generateFacebookShareUrl(jobId, jobTitle, companyName);

      const expectedJobUrl = 'https://navilands.com/jobs/123';
      const expectedText = encodeURIComponent('Exciting Maritime Opportunity: Ship Captain at Ocean Lines! 🚢 #MaritimeJobs #Seafarer');
  ...
  describe('generateLinkedInShareUrl', () => {
    it('should generate correct LinkedIn share URL', () => {
      ...
      const result = service.generateLinkedInShareUrl(jobId, jobTitle, companyName);

      const expectedJobUrl = 'https://navilands.com/jobs/123';
      const expectedTitle = encodeURIComponent('Maritime Career Opportunity: Ship Captain at Ocean Lines');
  ...
  describe('generateTwitterShareUrl', () => {
    it('should generate correct Twitter share URL', () => {
      ...
      const result = service.generateTwitterShareUrl(jobId, jobTitle, companyName);

      const expectedJobUrl = 'https://navilands.com/jobs/123';
      const expectedText = encodeURIComponent('🚢 New Maritime Opportunity: Ship Captain at Ocean Lines! Check it out: #MaritimeJobs #Seafarer');
